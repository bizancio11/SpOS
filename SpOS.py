...
MUSIC_FILE = "https://github.com/bizancio11/SpOS/09.Revolve (R Mix).mp3"#os.path.join(os.path.dirname(__file__), "09. Revolve (R Mix).mp3") # Asegúrate de tener este archivo en el mismo directorio
